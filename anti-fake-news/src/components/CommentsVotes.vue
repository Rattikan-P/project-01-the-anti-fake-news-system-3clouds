  ...
  <div ref="commentsSection">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-end gap-4 mb-4">
      <div class="flex items-center gap-2 w-full sm:w-auto">
        <label for="filter-select" class="text-gray-700 font-medium whitespace-nowrap"
          >Filter by:</label
        >
      ...
      <div class="flex items-center gap-2 w-full sm:w-auto">
        <label for="sort-select" class="text-gray-700 font-medium whitespace-nowrap"
          >Sort by:</label
        >
        <div class="relative w-full">
          <select
    ...
    >
      <div class="relative max-w-5xl max-h-full" @click.stop>
        ...
        <img
          ...
          class="max-w-full max-h-screen-75 object-contain rounded-lg shadow-xl"
        />
      </div>
    </div>
  </div>
