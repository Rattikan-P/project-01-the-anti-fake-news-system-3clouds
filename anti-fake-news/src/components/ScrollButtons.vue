  ...
  <div>
    ...
    >
      <button
        ...
        @click="scrollToTop"
        class="fixed bottom-6 right-6 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg z-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
