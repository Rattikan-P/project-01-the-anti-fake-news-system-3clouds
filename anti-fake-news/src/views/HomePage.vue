<template>
  <div class="container mx-auto p-4">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
      ...
      <div class="flex space-x-2">
        ...
        >
          ...
          <div
            v-if="isFilterLoading && pendingFilter === 'all'"
        ...
        >
          <span :class="{ 'opacity-50': isFilterLoading && pendingFilter === 'not fake' }"
            >Real</span
          >
          <div
            v-if="isFilterLoading && pendingFilter === 'not fake'"
            class="absolute inset-0 flex items-center justify-center"
          >
            <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
          </div>
        ...
        >
          ...
          <div
            v-if="isFilterLoading && pendingFilter === 'fake'"
            class="absolute inset-0 flex items-center justify-center"
          >
            <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
          </div>
        ...
        >
          ...
          <div
            v-if="isFilterLoading && pendingFilter === 'equal'"
            class="absolute inset-0 flex items-center justify-center"
          >
            <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
          </div>
    ...
    <div
      v-else-if="paginatedNews.length"
...
const filteredAndSearchedNews = computed<News[]>(() => {
  ...
  return filteredNews.value.filter(
    (news) =>
